...
using SS.Infrastructure.Common.Extensions;

namespace SS.Infrastructure.Localization;

/// <summary>
///     Provides PO files for Ngclopedia Localization.
/// </summary>
public class SSPoFileLocationProvider : ILocalizationFileLocationProvider
{
    private readonly IFileProvider _fileProvider;
    private readonly string _resourcesContainer;

    public SSPoFileLocationProvider(IHostEnvironment hostingEnvironment,
